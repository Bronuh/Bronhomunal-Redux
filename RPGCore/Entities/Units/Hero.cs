...
namespace RPGCore.Entities
{
	...
	{
		public event HeroBoughtItemHandler HeroBoughtItem;
		public event HeroLevelUpEventHandler HeroLevelUp;
		public event HeroRessurectedEventHandler HeroRessurected;
		public event HeroSoldEventHandler HeroSoldItem;
		...
		{
			HeroLevelUp?.Invoke(this, new HeroLevelUpEventArgs());
			Level++;
			SkillPoints++;
		}
	}
